...
const ServicesSection = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Комплексний брендинг та маркетингова стратегія для створення сильного ринкового позиціонування вашого бізнесу.',
      features: ['Брендингова стратегія', 'Позиціонування бренду', 'Маркетинговий план', 'Конкурентний аналіз'],
    ...
    {
      id: 6,
      title: 'Створення креативів для реклами',
      description: 'Дизайн рекламних матеріалів, які привертають увагу та конвертують. Від банерів до відео-креативів.',
      features: ['Дизайн банерів', 'Відео-креативи', 'Анімація', 'UGC контент'],
    ...
    },
    {
      ...
      description: 'Створення висококонвертуючих лендингів та корпоративних сайтів, які продають ваші товари та послуги.',
      features: ['Адаптивний дизайн', 'Швидка загрузка', 'SEO оптимізація', 'Аналітика конверсій'],
    ...
    {
      id: 8,
      title: 'Логотипи та брендинг',
      description: 'Розробка унікальних логотипів та комплексної айдентики, яка виділить ваш бренд серед конкурентів.',
      features: ['Логотип та знак', 'Фірмовий стиль', 'Брендбук', 'Упаковка продукту'],
